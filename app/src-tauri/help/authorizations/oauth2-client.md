...
You can optionally specify a [Certificate](help:workspace/certificates) and/or [Proxy](help:workspace/proxies) to use when retrieving a token. If you specify these settings for the Authorization, they do not automatically apply to [Requests](help:workspace/requests) or [Request Groups](help:workspace/groups), you must configure those separately.
